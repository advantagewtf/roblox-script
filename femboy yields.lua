if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("Femboy Yield is already running!", 0)
    return
end
...
everyClipboard = missing("function", setclipboard or toclipboard or set_clip	board or (Clipboard and Clipboard.set))
...
Title.TextSize = 18
Title.Text = "Femboy Yield" .. currentVersion
...
Credits.Text = "Gio is a cute femmie boy daddy"
